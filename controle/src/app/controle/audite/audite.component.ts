...
@Component({
  selector: 'app-audite',
  templateUrl: './audite.component.html',
  styleUrls: ['../shared/style/style.css'],
})
export class AuditeComponent implements OnInit {
  ...
  inspectionForm = new FormGroup({
    ...
    type_categorie: new FormControl('audit', [Validators.required]),
