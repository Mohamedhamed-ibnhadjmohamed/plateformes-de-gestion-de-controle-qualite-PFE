...
@Component({
  selector: 'app-pdfimprimer',
  templateUrl: './pdfimprimer.component.html',
  styleUrl: './pdfimprimer.component.css',
})
export class PdfimprimerComponent {
  ...
  ngOnInit(): void {
    ...
    this.getAllfamilledefault();
     if (this.idInspection && this.defaults) {
       this.imprimer();
     }
  }
